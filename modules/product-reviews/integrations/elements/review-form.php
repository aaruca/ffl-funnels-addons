...
class FFLA_Review_Form extends \Bricks\Element
{
    ...
    public function render()
    {
        ...
        $show_criteria = !isset($settings['showOptionalCriteria']) || !empty($settings['showOptionalCriteria']);
        $collapse_media = !isset($settings['collapseMedia']) || !empty($settings['collapseMedia']);
