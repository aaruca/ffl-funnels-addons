 ...
 * Author URI:        https://github.com/aaruca
...
if (!class_exists('FFL_Funnels_Addons')):
    ...
    final class FFL_Funnels_Addons
    {
        ...
        private function includes(): void
        {
            ...
            require_once FFLA_PATH . 'includes/class-ffla-options.php';
            ...
            require_once FFLA_PATH . 'modules/pickup-shipping/class-pickup-shipping-module.php';
        ...
        private function register_modules(): void
        {
            ...
            $this->registry->register(new Pickup_Shipping_Module());
